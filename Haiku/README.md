...
###I repeated the terminla commands shown in class, then located the aiff file in the documents folder. 
![image](haiku.png)
####It took me a while to figure out how to embed the image above. I found this thread on stackoverflow to be helpful.
